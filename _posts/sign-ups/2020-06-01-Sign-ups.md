...
---
**Season 41** will run from Monday, July 20 until Sunday, August 30 and you can sign up until ~~Monday, July 13 at 15:00 UTC~~. **Sign-ups are now officially closed**, but you can still sign up below to join the waiting list until **Monday, July 27 at 15:00 UTC**. If there is a space suitable for you, you will be added to fill all divisions up to 6 players each. Sign up by filling out the [Google form](#sign-up-using-this-google-form) below.
