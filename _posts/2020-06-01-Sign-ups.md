...
**NOTE:** Season 40 players should **not** use this signup form and should instead fill out the Returning Form which is pinned in their division channel on Discord.
<br>
<div class="sheets">
...
#### Sign-ups and Counts
Signups and Counts are listed below (it may take a few seconds to load).
<br>
