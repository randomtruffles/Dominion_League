...
### Changed: *Recruiting* ~~Evaluating~~ new moderator*s* ~~applicants~~ ([8.5](/rules#8.5))

> ~~When t~~*T*he moderator team ~~opens applications for new moderators per [8.5](#8.5), they~~ will follow this process *when evaluating new moderator applications*:
>
