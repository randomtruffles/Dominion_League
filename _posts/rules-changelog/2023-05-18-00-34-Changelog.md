...
> If you or your opponent have connection issues, or otherwise cannot continue a game (e.g. due to ~~connection issues or~~ time constraints), you should suspend the game. Note the game ID*, then resign the game.* ~~and u~~*U*se the Load Old Game button to reload the same game another time.
