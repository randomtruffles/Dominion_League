...
>
> 2.4.4. Players returning to the League after a long break ([1.4.2](/rules#1.4.2)) are placed according to their decay-adjusted returning tier ([2.4.4.2](/rules#2.4.4.2)) or their level-based placement ([2.4.4.1](/rules#2.4.4.1)), whichever is higher.
>
...
> 
> 2.4.4.2. A player's decay-adjusted returning tier is the tier they would have most recently returned to (adjusted according to any intervening structural transition schemes), reduced by 1 tier for each 6 full seasons their break lasted, up to a maximum reduction of 3 tiers. Thus, breaks of less than 6 seasons incur no decay, breaks of 6-11 seasons incur 1 tier of decay, breaks of 12-17 seasons incur 2 tiers of decay, and breaks of 18+ seasons incur 3 tiers of decay. A player's decay-adjusted returning tier cannot be below the league's lowest tier (see [2.3](/rules#2.3)).
>
> 2.4.4.3. When placing players according to their decay-adjusted returning tier, slots are filled starting with A tier and working downward. If there is insufficient space in a given tier to accommodate such players, they will be placed in the highest possible tier below that tier that can accommodate them without needing a flex division to do so, starting with the players who played most recently, and with ties broken by seeding ([2.6](/rules#2.6)).
