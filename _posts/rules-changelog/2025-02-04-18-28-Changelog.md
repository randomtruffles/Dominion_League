...
### Added: Extra/non-standard matches ([4.16.2](/rules#4.16.2))

> 4.16.2. Three player tiebreaker matches are 3-game, round-robin matches. Players rotate being starting player in game 1 of a match, such that each player is starting player in game 1 of one of their two matches.
