...
>
> 2.4.4. Players returning to the League after a long break ([1.4.2](/rules#1.4.2)) are placed according to their adjusted returning tier ([2.4.5.2](/rules#2.4.4.2)) or their level-based placement ([2.4.5.1](/rules#2.4.4.1)), whichever is higher.
>
