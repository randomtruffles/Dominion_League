...
> 
> 2.4.4.2. A player's decay-adjusted returning tier is the tier they earned in the season they last played (adjusted according to any intervening structural transition schemes), reduced by 1 tier for each 6 full seasons their break lasted, up to a maximum reduction of 3 tiers. For example, the decay-adjusted returning tier of a player who last earned placement in B and then took a 6-11 season break would be C. A player's adjusted returning tier cannot be below the league's lowest tier (see [2.3](/rules#2.3)).
>
