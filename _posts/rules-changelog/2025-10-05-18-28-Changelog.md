...
>
> 3.5.4. You receive a play speeding warning for any match in which your adjusted excess time crosses the threshold established in [3.5](/rules#3.5).
>
> 3.5.5. If you receive multiple play speed warnings in consecutive seasons, or in three out of five consecutive seasons, you receive a suspension (see [7.2.3](/rules#7.2.3)).

### Added: Suspensions ([7.2.3](/rules#7.2.3))

> The default suspension for excessive play speed warnings (see [3.5](/rules#3.5)) is one season.