        ...
        for row in values:
            ...
            # Gen dictionary
                ...
                for p_idx, player in enumerate(players):
                    ...
                    if (tiers[p_idx] == "" or (curr_division["by_player"][player]["games_nondrop"] < total_games)) and player not in late_drops and curr_division["complete?"] == "Yes":
