...
- At the start of each turn, a player's timer will increment 2.5 seconds times the maximum number of decisions they made on any of their 3 previous turns
